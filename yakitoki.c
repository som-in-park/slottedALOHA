...
int initialAUE(int n, int accessTime, int maxTime);
...
int main(int argc, char** argv) {
    ...
    for (int n = 10000; n <= 100000; n += 10000) {
        ...
        int nAccessUE = initialAUE(n, accessTime, maxTime);
        ...
        sprintf(fileNameResult, "2_Exclude_msg2_failures_UE%05d_Results.txt", nUE);
        ...
        sprintf(fileNameResultLog, "2_Exclude_msg2_failures_UE%05d_Logs.txt", nUE);
